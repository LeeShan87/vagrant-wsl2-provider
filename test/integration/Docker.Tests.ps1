...
Describe "Vagrant WSL2 Provider - Docker Support" {
    ...
    Context "Testing <Name> distribution" -ForEach $script:TestMachines {

        It "Should successfully bring up with Docker" {
